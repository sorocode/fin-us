...
Fin-Us는 **MCP (Model Context Protocol)** 아키텍처를 활용하여 실시간 뉴스 분석과 증권사 API 연동을 결합한 차세대 AI 투자 에이전트 시스템입니다. LLM(gpt-5.4-mini, claude-sonnet-4-6)이 시장 상황을 분석하고, 한국투자증권(KIS) API를 통해 실질적인 자산 관리 및 매매 전략을 제안합니다.
...
- **AI 의사결정**: 수집된 뉴스를 바탕으로 gpt-5.4-mini 또는 claude-sonnet-4-6 모델이 투자 등급(BUY/SELL/HOLD)과 신뢰도 점수, 근거가 포함된 리포트를 생성합니다. (제공자 선택 가능)
